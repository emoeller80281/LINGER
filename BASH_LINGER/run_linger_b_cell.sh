...
DATA_DIR="/gpfs/Labs/Uzun/DATA/PROJECTS/2024.GRN_BENCHMARKING.MOELLER/LINGER/B_CELL_DATA"
RESULTS_DIR="/gpfs/Labs/Uzun/RESULTS/PROJECTS/2024.GRN_BENCHMARKING.MOELLER/LINGER/B_CELL_RESULTS"
...
RNA_DATA_PATH="${DATA_DIR}/${SAMPLE_NUM}_RNA_B_cell_L2.csv"
ATAC_DATA_PATH="${DATA_DIR}/${SAMPLE_NUM}_ATAC_B_cell_L2.csv"
...
LOG_DIR="${SCRIPTS_DIR}/LOGS/${SAMPLE_NUM}/B_CELL"
