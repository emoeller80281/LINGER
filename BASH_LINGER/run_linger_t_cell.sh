...
DATA_DIR="/gpfs/Labs/Uzun/DATA/PROJECTS/2024.GRN_BENCHMARKING.MOELLER/LINGER/T_CELL_DATA"
RESULTS_DIR="/gpfs/Labs/Uzun/RESULTS/PROJECTS/2024.GRN_BENCHMARKING.MOELLER/LINGER/T_CELL_RESULTS"
...
RNA_DATA_PATH="${DATA_DIR}/${SAMPLE_NUM}_RNA_T_cell_L2.csv"
ATAC_DATA_PATH="${DATA_DIR}/${SAMPLE_NUM}_ATAC_T_cell_L2.csv"
...
LOG_DIR="${SCRIPTS_DIR}/LOGS/${SAMPLE_NUM}/T_CELL"
...
run_pipeline() {
    ...
    if [ -f "${GRN_FILE}" ]; then
        ...
        cp "${GRN_FILE}" "LINGER_INFERRED_GRNS/${CELLTYPE}/${SAMPLE_NUM}/linger_${CELLTYPE}_${SAMPLE_NUM}.txt"
    fi
