...
DATA_DIR="/gpfs/Labs/Uzun/DATA/PROJECTS/2024.GRN_BENCHMARKING.MOELLER/LINGER/IPS_CELL_DATA"
RESULTS_DIR="/gpfs/Labs/Uzun/RESULTS/PROJECTS/2024.GRN_BENCHMARKING.MOELLER/LINGER/IPS_CELL_RESULTS"
...
RNA_DATA_PATH="${DATA_DIR}/${SAMPLE_NUM}_RNA_iPS_cell_L2.csv"
ATAC_DATA_PATH="${DATA_DIR}/${SAMPLE_NUM}_ATAC_iPS_cell_L2.csv"
...
LOG_DIR="${SCRIPTS_DIR}/LOGS/${SAMPLE_NUM}/IPS"
...
check_homer() {
    ...
    if grep -q "${GENOME}" "$HOMER_CONFIG"; then
        ...
        touch "${LOG_DIR}/install_homer_species.log"
